...
| `image.command`                               | Specify Image run command                                                                                                                                 | `["rskj"]`                                                       |
...
| `container.http`                              | rskj Container http JSON-RPC port                                                                                                                                                           | `8545`                                                        |
| `container.ws`                                | rskj Container websocket JSON-RPC port                                                                                                                                                           | `8546`                                                        |
| `service.type`                                | Kubernetes Service type                                                                                                                                                   | `ClusterIP`                                                   |
| `service.http`                                | rskj Service http JSON-RPC port                                                                                                                                                           | `8545`                                                        |
| `service.ws`                                  | rskj Service websocket JSON-RPC port                                                                                                                                                           | `8546`                                                        |
...
| `persistence.size`                            | PVC Storage Request for rskj volume                                                                                                                                 | `300Gi`                                                         |
