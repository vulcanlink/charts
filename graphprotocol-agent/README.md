...
| `container.http`                              | graphprotocol-agent Container http port                                                                                                                                         | `8000`                                                        |
| `container.jsonRpc`                                | graphprotocol-agent Container JSON-RPC port                                                                                                                                    | `8020`                                                        |
| `container.metrics`                                | graphprotocol-agent Container Prometheus metrics port                                                                                                                                    | `8040`                                                        |
| `service.type`                                | Kubernetes Service type                                                                                                                                                   | `ClusterIP`                                                   |
| `service.http`                                | graphprotocol-agent Service http port                                                                                                                                           | `8000`                                                        |
| `service.ws`                                  | graphprotocol-agent Service JSON-RPC port                                                                                                                                      | `8020`                                                        |
| `service.metrics`                                  | graphprotocol-agent Service Prometheus metrics port                                                                                                                                      | `8040`                                                        |
...
| `persistence.storageClass`                    | PVC Storage Class for graphprotocol-agent volume                                                                                                                                   | `nil`                                                         |
| `persistence.accessModes`                     | PVC Access Mode for graphprotocol-agent volume                                                                                                                                     | `[ReadWriteOnce]`                                             |
| `persistence.size`                            | PVC Storage Request for graphprotocol-agent volume                                                                                                                                 | `300Gi`                                                       |
